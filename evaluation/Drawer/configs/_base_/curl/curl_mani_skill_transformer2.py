...
agent = dict(
    ...
    gamma=0.95,
    feature_dim=192,
    encoder_optim_cfg=dict(type='Adam', lr=5e-4, weight_decay=5e-6),
    encoder_cfg=dict(
    ...
    value_cfg=dict(
        ...
        nn_cfg=dict(
            type='LinearMLP',
            norm_cfg=None,
            mlp_spec=['192 + action_shape', 128, 1],
            bias='auto',
            inactivated_output=True,
            linear_init_cfg=dict(type='xavier_init', gain=1, bias=0),
        ),
...
train_mfrl_cfg = dict(
    ...
    n_updates=4,
    m_steps=8,
    init_replay_buffers=['/home/weikangwan/ManiSkill-Learn/door_data/OpenCabinetDoor_1000_link_0-v0.h5',
