...
from mani_skill_learn.methods.builder import build_mfrl
...
class UserPolicy(BasePolicy):
    def __init__(self, env_name):
        ...
        cfg_path = str(pathlib.Path('./configs/gail/gail_mani_skill_transformer_train.py').resolve())
        ...
        load_checkpoint(self.agent,
            str(pathlib.Path('./work_dirs/model_2900000.ckpt').resolve()),
            map_location='cpu'
        )
